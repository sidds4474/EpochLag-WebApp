...
const NEXT_ONBOARDING_STEP = "/onboarding/contacts";
...
export default function PhonePage() {
  ...
  const handleNext = () => {
    ...
    if (!digits) {
      setFieldError("Enter your phone number or tap Skip.");
      return;
    }
    ...
    // Fire-and-forget for snappy navigation.
    updatePhone(code, digits).catch((e) => {
    ...
    <main className="min-h-screen w-full flex bg-warm-cream items-stretch">
      ...
      <section className="relative flex-1 bg-warm-cream md:rounded-l-[48px] md:-ml-[48px] flex items-center justify-center px-[20px] md:px-[40px] py-[40px] md:py-[64px]">
        ...
        >
          ...
          >
            Sharing your phone number allows other user to find you on Epoch Lag
            and on their contact list
          </motion.p>
          ...
          >
            <div className="flex gap-[8px]">
              <input
                ...
                className="bg-primary-white rounded-full w-[78px] shrink-0 grow-0 basis-[78px] text-center px-[12px] py-[12px] font-montserrat font-medium text-primary-blue text-[14px] placeholder:text-black/30 focus:outline-none focus:ring-2 focus:ring-primary-blue/20"
              />
              <input
                type="tel"
                inputMode="tel"
                ...
                className="flex-1 min-w-0 bg-primary-white rounded-full px-[20px] py-[12px] font-montserrat font-medium text-primary-blue text-[14px] placeholder:text-black/30 focus:outline-none focus:ring-2 focus:ring-primary-blue/20"
              />
            </div>
