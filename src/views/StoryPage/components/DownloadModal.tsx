...
const DownloadModal = ({
  ...
  onClose,
  publicCode,
  trackEvent = "public_story_app_cta_clicked",
  ...
  const trackBadge = (store: string) => {
    if (typeof window === "undefined" || typeof window.gtag !== "function") return;
    const payload: Record<string, string> = { store, position };
    if (publicCode) payload.public_code = publicCode;
    window.gtag("event", trackEvent, payload);
  };
